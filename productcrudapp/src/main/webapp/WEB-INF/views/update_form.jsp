...
<div class="form-container">
        ...
        <input type="hidden" value="${product.id }" name="id">
            <div class="form-group">
                ...
                <input type="text" value="${product.name }" class="form-control" id="firstName" name="name" placeholder="Enter Product Name" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="${product.price }" id="price" name="price" placeholder="Enter product price" required>
            </div>
            <div class="form-group text-center">
                <a href="${pageContext.request.contextPath }/" class="btn btn-back btn-custom">Back</a>
                <button type="submit" class="btn btn-add btn-custom">Update Product</button>
            </div>
        </form>
    </div>
</body>
